...
import sqlite3
from login import Ui_Dialog as Ui_HomePage
...
class Ui_signUp(object):
    ...
    def toLoginPage(self):
        ...
        self.ui=Ui_HomePage()
        self.ui.setinUi(self.userHomeWindow)
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet(_fromUtf8("background-image: url(user_bg.jpg);"))
        # Dialog.setStyleSheet(_fromUtf8("border: 2px solid black"))

        #############################################################################

        self.label = QtGui.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(530 , 250, 130, 30))
        ...
        self.label_2.setGeometry(QtCore.QRect(530, 300, 130, 30))
        ...
        self.label_M.setGeometry(QtCore.QRect(530, 350, 130, 30))
        ...
        self.label_3.setGeometry(QtCore.QRect(530, 400, 130, 30))
        ...
        self.email_lineEdit.setGeometry(QtCore.QRect(700, 300, 300, 30))
        ...
        self.mob_lineEdit.setGeometry(QtCore.QRect(700, 350, 300, 30))
        self.mob_lineEdit.setObjectName(_fromUtf8("mob_lineEdit"))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.mob_lineEdit.setFont(font)

        self.password_lineEdit = QtGui.QLineEdit(Dialog)
        self.password_lineEdit.setGeometry(QtCore.QRect(700, 400, 300, 30))
        ...
        self.signup_btn.setGeometry(QtCore.QRect(700, 450, 300, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.toLogin_btn = QtGui.QPushButton(Dialog)
        self.toLogin_btn.setGeometry(QtCore.QRect(700, 500, 300, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.toLogin_btn.setFont(font)
        self.toLogin_btn.setObjectName(_fromUtf8("toLogin_btn"))
        #self.toLogin_btn.setStyleSheet("background-color: black")
        #########################EVENT##############
        self.toLogin_btn.clicked.connect(self.toLoginPage)
        ############################################

        self.exit = QtGui.QPushButton(Dialog)
        self.exit.setGeometry(QtCore.QRect(700, 550, 300, 30))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.toLogin_btn.setText(_translate("Dialog", "CLICK TO LOGIN PAGE", None))
